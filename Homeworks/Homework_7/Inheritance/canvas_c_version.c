...
canvas *canvas_create(canvas *this, const int width, const int height) {
...
canvas *new_canvas(const int width, const int height) {
...
void canvas_set(const canvas *this, const int x, const int y, const char c) {
    if (x >= 0 && x < this->width_ && y >= 0 && y < this->height_)
        this->ptr_[y * this->width_ + x] = c;
}

void canvas_line(canvas *this, int x0, int y0, const int x1, const int y1, const char c) {
...
void canvas_rectangle(canvas *this, const int x0, const int y0, const int x1, const int y1, const char c) {
...
void canvas_circle(canvas *this, const int xm, const int ym, int r, const char c) {
...
void canvas_out(const canvas *this, FILE *f) {
